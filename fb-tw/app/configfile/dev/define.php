...
define('LOG_DIR', '/home/admin/logs/island/facebooktw/debug');
...
define('APP_NAME', 'facebooktwisland');

define('DATABASE_NODE_NUM', 4);
define('MEMCACHED_NODE_NUM', 10);

define('HOST', 'http://devfacebooktw.happyfish001.com');
define('STATIC_HOST', 'http://devstaticisland.happyfish001.com/facebooktw');
