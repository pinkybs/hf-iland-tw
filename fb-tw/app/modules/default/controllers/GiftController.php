...
//        $url1 = HTTP_PROTOCOL.'apps.facebook.com/' . APP_NAME . '/gift/top/t/2';
//		$url2 = HTTP_PROTOCOL.'apps.facebook.com/' . APP_NAME . '/pay/top';
//
//        /* for 外联通  20110702 */
//		$this->view->connectSnsplus = '';
//        $entrance = $this->_request->getParam('entrance');
//        //from snsplus
//        if ('connect' == $entrance) {
//			$url1 = $this->view->hostUrl . '/gift/top?t=2&entrance=connect';
//            $url2 = $this->view->hostUrl . '/pay/top?entrance=connect';
//        }

		switch ($t){
			case 1:
			    $msg = "<p>" . LANG_PLATFORM_INDEX_TXT_04 . "<br/></p><p>" . LANG_PLATFORM_INDEX_TXT_05 . '<a href="javascript:void(0);" onclick="topGift();"><b>' . LANG_PLATFORM_INDEX_TXT_06 ."</b></a>" . LANG_PLATFORM_INDEX_TXT_07 . "</p>";
			break;
			case 2:
				//$msg = "<p>" . LANG_PLATFORM_INDEX_TXT_08 . "<a href='"  . $url2 . "'><b>" . LANG_PLATFORM_INDEX_TXT_09 . "</b></a></p>";
				$msg = "<p>" . LANG_PLATFORM_INDEX_TXT_08 . "<a href='javascript:void(0);'><b>" . LANG_PLATFORM_INDEX_TXT_09 . '</b> onclick=' . "goPayGift();" . '</a></p>';
			break;
		}
