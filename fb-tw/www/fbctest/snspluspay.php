...
define('SITE_URL'	,	'http://'.$_SERVER["HTTP_HOST"].str_ireplace(trim(strip_tags($_SERVER["DOCUMENT_ROOT"])),'',SITE_PATH));
define('ITEMPATH'   ,   'http://pay.snsplus.com/facebook_credit/');
