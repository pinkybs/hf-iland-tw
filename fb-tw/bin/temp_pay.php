...
try {
    Hapyfish2_Island_Stat_Bll_DailyPayment::saveDailyPayToDbByDate('20110527');
	Hapyfish2_Island_Stat_Bll_DailyPayment::saveDailyPayToDbByDate('20110528');
	Hapyfish2_Island_Stat_Bll_DailyPayment::saveDailyPayToDbByDate('20110529');
	Hapyfish2_Island_Stat_Bll_DailyPayment::saveDailyPayToDbByDate('20110530');
	exit;
}
catch (Exception $e) {
